...
- Browse existing [GitHub Issues](https://github.com/Chisanan232/abe-kafka/issues) to find something to work on
...
1. Go to the [abe-kafka repository](https://github.com/Chisanan232/abe-kafka)
...
git remote add upstream https://github.com/Chisanan232/abe-kafka.git
...
<Tabs>
  ...
  <TabItem value="poetry" label="poetry">
    ...
    # Run with coverage report
    poetry run pytest --cov=abe_plugin
...
All pull requests are automatically checked with our [CI/CD pipeline](./ci-cd.mdx), which:
- Runs all tests
...
- Ask questions in the [GitHub Discussions](https://github.com/Chisanan232/abe-kafka/discussions)
