...
Before you begin contributing to abe-kafka, ensure your development environment meets these requirements.
...
2. **Create a virtual environment**:
   ...
   <Tabs>
     ...
     ```bash
     conda create -n abe-kafka python=3.13
     conda activate abe-kafka
     ```
