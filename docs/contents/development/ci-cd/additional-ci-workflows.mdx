...
The [`docs-build-check.yaml`](https://github.com/Chisanan232/abe-kafka/blob/master/.github/workflows/docs-build-check.yaml) workflow validates that documentation builds successfully whenever documentation-related files are modified.
...
[![Docs-only auto-approve & automerge](https://github.com/Chisanan232/abe-kafka/actions/workflows/docs-automerge.yml/badge.svg)](https://github.com/Chisanan232/abe-kafka/actions/workflows/docs-automerge.yml)
