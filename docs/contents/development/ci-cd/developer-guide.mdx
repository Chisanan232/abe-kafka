...
This section previously covered container image tagging and is not applicable for this project.

### SBOM Generation

Security scanning applies to Python package artifacts and documentation where relevant.
...
**Primary Workflows**:
- [Release Workflow](https://github.com/Chisanan232/abe-kafka/actions/workflows/release.yml)
- [Validation Results](https://github.com/Chisanan232/abe-kafka/actions/workflows/release-validate.yml)
...
[![docs-automerge](https://github.com/Chisanan232/abe-kafka/actions/workflows/docs-automerge.yml/badge.svg)](https://github.com/Chisanan232/abe-kafka/actions/workflows/docs-automerge.yml)
...
[![CD](https://github.com/Chisanan232/Template-Python-UV-Project/actions/workflows/cd.yaml/badge.svg)](https://github.com/Chisanan232/Template-Python-UV-Project/actions/workflows/cd.yaml)
...
**Browse All Workflows**: [Workflow Definitions](https://github.com/Chisanan232/abe-kafka/tree/master/.github/workflows)
