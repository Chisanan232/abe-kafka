...
[![GitHub release](https://img.shields.io/github/v/release/Chisanan232/abe-kafka?display_name=tag&color=24292e&logo=github)](https://github.com/Chisanan232/abe-kafka/releases)
...
[![Release](https://github.com/Chisanan232/abe-kafka/actions/workflows/release.yml/badge.svg)](https://github.com/Chisanan232/abe-kafka/actions/workflows/release.yml)
[![PyPI version](https://img.shields.io/pypi/v/abe-kafka?label=PyPI&color=306998&logo=pypi)](https://pypi.org/project/abe-kafka/)

Publishes production artifacts (PyPI package and docs) using the centralized `rw_release_complete.yaml` workflow logic.
...
- **Targets** – PyPI (wheel + sdist) and the published Docusaurus docs site.
...
[![Release Staging](https://github.com/Chisanan232/abe-kafka/actions/workflows/release-staging.yml/badge.svg)](https://github.com/Chisanan232/abe-kafka/actions/workflows/release-staging.yml)
[![TestPyPI version](https://img.shields.io/badge/dynamic/json?label=TestPyPI&color=ff6600&query=%24.info.version&url=https%3A%2F%2Ftest.pypi.org%2Fpypi%2Fabe-kafka%2Fjson&logo=pypi)](https://test.pypi.org/project/abe-kafka/)

Creates staging/TestPyPI packages and preview documentation to test releases before production.

- **Purpose** – Provide a safe rehearsal of the full release pipeline with artifacts you can share internally.
- **Effects** – Publishes release-candidate packages and deploys docs to preview channels without touching production identifiers.
- **Targets** – TestPyPI and preview docs buckets or branches.
...
flowchart LR
    ...
    targets[(TestPyPI · Preview docs)]:::targets
...
[![Release Validation](https://github.com/Chisanan232/abe-kafka/actions/workflows/release-validate.yml/badge.svg)](https://github.com/Chisanan232/abe-kafka/actions/workflows/release-validate.yml)
...
- **Multi-target support**: Python packages and documentation publishing remain available through the shared workflows.
