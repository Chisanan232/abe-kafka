...
We appreciate your help in identifying and reporting bugs in abe-kafka. A well-documented bug report helps us understand and fix issues quickly.

## Before Reporting

Before submitting a bug report, please:

1. **Check existing issues**: Search the [GitHub Issues](https://github.com/Chisanan232/abe-kafka/issues) to see if the bug has already been reported.
...
Please submit bug reports through our [GitHub Issues](https://github.com/Chisanan232/abe-kafka/issues) page using the "Bug Report" template.
